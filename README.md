...
- [x] Минимум 3 таблицы в БД (PostgreSQL) — **Выполнено**
- [x] Взаимодействие через JDBC — **Выполнено**
- [x] Роли ADMIN/USER и запрет на второго админа — **Выполнено**
- [x] JWT Токенная аутентификация — **Выполнено**
- [x] 4 канала рассылки (SMS, Email, TG, File) — **Выполнено**
- [x] Механизм автоматического просрочивания кодов — **Выполнено**
- [x] Подробное логирование всех запросов — **Выполнено**